package com.mertoenjosh.mymemory
...
import com.mertoenjosh.mymemory.models.BoardSize
import com.mertoenjosh.mymemory.utils.*
...
class CreateActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val PICK_PHOTO_CODE = 27
        private const val READ_EXTERNAL_PHOTOS_CODE = 83
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ensures max length of the user input is 14
        ...
        rvImagePicker.setHasFixedSize(true) // improve efficiency
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == READ_EXTERNAL_PHOTOS_CODE) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "In order to create a custom game, You need to allow access to photos", Toast.LENGTH_LONG).show()
            }
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (clipData != null) {
            Log.i(TAG, "cliData numImages ${clipData.itemCount}: $clipData")
    ...
    private fun saveDataToFireBase() {
        ...
        // check we are not overriding someone else's game
        db.collection("games").document(customGameName).get().addOnSuccessListener { document ->
            if (document != null && document.data != null) {
                AlertDialog.Builder(this)
                    .setTitle("Name Taken")
                    .setMessage("A game with name '$customGameName' already exists. Please choose another name")
    ...
    private fun shouldEnableSaveButton(): Boolean {
        // if we should enable the save button
        if(chosenImageUris.size != numImagesRequired) {
            return false
        }
